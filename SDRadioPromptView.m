...
//屏幕尺寸
#define Radio_SCREEN_W [UIScreen mainScreen].bounds.size.width
#define Radio_SCREEN_H [UIScreen mainScreen].bounds.size.height
...
#define Bottom_Marigin         (IS_iPhone_X_ALL ? 34.f : 0.f)
...
-(instancetype)initWithPromptTitle:(NSString *)title cellArray:(nonnull NSArray * )cellArr indexPath:(NSIndexPath*)indexPath{
    ...
    if (self =[super init]) {
        ...
        promptView.frame = CGRectMake(0, Radio_SCREEN_H, Radio_SCREEN_W, Radio_SCREEN_H*0.5);
        ...
        titleLab.frame = CGRectMake(0, 0, Radio_SCREEN_W, 50);
        ...
        submitBtn.frame = CGRectMake(0, promptView.bounds.size.height - 60, Radio_SCREEN_W, 60);
...
-(void)show{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        self.promptView.frame = CGRectMake(0, Radio_SCREEN_H*0.5 - Bottom_Marigin, Radio_SCREEN_W, Radio_SCREEN_H*0.5);
...
-(void)dismiss{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        self.alpha = 0;
         self.promptView.frame = CGRectMake(0, Radio_SCREEN_H, Radio_SCREEN_W, Radio_SCREEN_H*0.5);
